<div>
    <div>
        ...
        <select wire:model="selectedCountry" id="country_id"
    ...
    @if ($selectedCountry)
        <div class="mt-2">
            ...
            <svg wire:target="selectedCountry" wire:loading class="animate-spin ml-1 h-5 w-5"
            ...
            <select wire:model="selectedState" id="state_id"
                class="ring-1 ring-gray-300 w-full rounded-md px-4 py-2 mt-2 outline-none
            focus:ring-2 focus:ring-purple-300">
    ...
    @if ($selectedState)
        <div class="mt-2">
            ...
            <svg wire:target="selectedState" wire:loading class="animate-spin ml-1 h-5 w-5"
                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor"
                    stroke-width="4"></circle>
                <path class="opacity-75" fill="currentColor"
            ...
            <select wire:model="selectedCity" id="city_id"
                class="ring-1 ring-gray-300 w-full rounded-md px-4 py-2 mt-2 outline-none
            focus:ring-2 focus:ring-purple-300">
